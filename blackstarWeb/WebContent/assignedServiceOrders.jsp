<script type="text/javascript">
	...
	function assignedServiceOrders_init(){

		// Tabla de ordenes de servicio pendientes
		getAssignedServiceOrders();
	}	
	
	function getAssignedServiceOrders(){
		$.getJSON("/dashboard/assignedServiceOrdersJson.do", function(data){
			// Inicializacion de tabla de ordenes de servicio con algun pendiente
			$('#dtAssignedServiceOrders').dataTable({	
					"bProcessing": true,
					"bFilter": true,
					"bLengthChange": false,
					"iDisplayLength": 10,
...
-->
	<div class="grid_16">
		<div class="box">
			<h2>Ordenes de Servicio Asignadas</h2>
			<div class="utils">
				
			</div>
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="dtAssignedServiceOrders">
				<thead>
					<tr>
						<th>Folio</th>
						<th></th>
