						...
						<div class="box">
							...
							<table>
								...
								<tr>
									...
									<td><input id="evaDescription" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input id="evaLectureTemp" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input id="evaCheckOperatation" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									...
									<td><input id="evaCheckNoise" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									<td>1.15 CORRECTO AISLAMIENTO DE TUBERÍA Y TAPAS DEL EQUIPO</td>
									<td><input id="evaCheckIsolated" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input id="evaCheckFluidSensor" type="text" style="width:95%;" /></td>
								</tr>	
								<tr>
									<td>1.19 REQUERIMIENTO DE LAMINADO Y PINTURA EN EL EQUIPO</td>
									<td><input id="evaRequirMaintenance" type="text" style="width:95%;" /></td>
								</tr>	
							</table>
							<table>
								<thead>
								...
								<tr>
									...
									<td><input id="condReview" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									<td>2.2	INSPECCIÓN Y LIMPIEZA DEL SISTEMA ELÉCTRICO, PROTECCIONES, CABLEADO, TERMINALES Y CONTACTORES</td>
									<td><input id="condCleanElectricSystem" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									<td>2.3	LAVADO DE CONDENSADOR (DRY FLUID COOLER) CON LIQUIDO DESINCRUSTANTE Y AGUA A PRESIÓN</td>
									<td><input id="condClean" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									<td>2.4	TOMA DE LECTURAS DE VOLTAJE</td>
									<td>Fases a tierra</td>
									<td><input id="condLectureVoltageGroud" type="text" style="width:95%;" /></td>
									<td>Entre fases</td>
									<td><input id="condLectureVoltagePhases" type="text" style="width:95%;" /></td>
									<td>Control</td>
									<td><input id="condLectureVoltageControl" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									<td>2.5	LECTURA DE CORRIENTE EN MONITORES DE CONDENSADOR</td>
									<td><input id="condLectureMotorCurrent" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									<td>2.6	REVISIÓN Y AJUSTE DE TERMOSTATO</td>
									<td><input id="condReviewThermostat" type="text" style="width:95%;" /></td>
								</tr>
								<tr>
									<td>MODELO:</td>
									<td><input id="condModel" type="text" style="width:95%;" /></td>
									<td>No. DE SERIE:</td>
									<td><input id="condSerialNumber" type="text" style="width:95%;" /></td>
									<td>MARCA:</td>
									<td><input id="condBrand" type="text" style="width:95%;" /></td>
								</tr>
							</table>
