...
$(document).ready(function() {
  ...
  function postAssignedTicket(pTicketId, pEmployee){
	...
	function getActiveTickets(){
		$.getJSON("/dashboard/activeTicketsJson.do", function(data){
...
<div class="grid_16">
	<div class="box">
		...
		<div id= ticketTablaContainer>
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="activeTicketsTable">
				<thead>
					<tr> 
		 ...
		 <form id="frmFile" action="/dashboard/getTicketsFile.do" target="_blank">
