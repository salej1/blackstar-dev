...
public class UPSServiceReport extends AbstractReport {
  ...
  public static void main(String [] args) throws Exception{
	...
	upsService.setInputVoltageNeutroGround("3");
	upsService.setPercentCharge("4");
	upsService.setOutputVoltagePhase("5");
	upsService.setOutputVoltageNeutro("6");
	upsService.setInOutFrecuency("7");
	upsService.setBusVoltage("8");
