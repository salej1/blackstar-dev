...
public class AirConditioningReport extends AbstractReport {
  ...
  private void printEvaporator() throws Exception {
	 ...
	 drawer.text(serviceCheckEval(data.getEvaReviewFilter()), 418, 239, true);
	 ...
	 drawer.text(serviceCheckEval(data.getEvaReviewStrip()), 418, 253, true);
	 ...
	 drawer.text(serviceCheckEval(data.getEvaCleanElectricSystem()), 418, 267, true);
	 ...
	 drawer.text(serviceCheckEval(data.getEvaCleanControlCard()), 418, 281, true);
	 ...
	 drawer.text(serviceCheckEval(data.getEvaCleanTray()), 418, 295, true);
	 ...
	 drawer.text(serviceCheckEval(data.getEvaCheckFluidSensor()) , 418, 450, true);
	 drawer.hLine(0, 555, 453, 0x0155A5);
	 drawer.text("1.19 REQUERIMIENTO DE LAMINADO Y/O  PINTURA EN EQUIPO", 5, 464, false, 0, 6);
	 drawer.text(serviceCheckEval(data.getEvaRequirMaintenance()), 418, 464, true);
  ...
  private void printCondenser() throws Exception {
	...
	drawer.text(serviceCheckEval(data.getCondCleanElectricSystem()), 418, 517, true);
	...
	drawer.text(serviceCheckEval(data.getCondClean()) , 418, 531, true);
  ...
  public static void main(String [] args) throws Exception{
	...
	airCo.setEvaFlagCalibration(1);
	airCo.setEvaReviewFilter(0);
	airCo.setEvaReviewStrip(0);
	airCo.setEvaCleanElectricSystem(1);
	airCo.setEvaCleanControlCard(0);
	airCo.setEvaCleanTray(1);
	...
	airCo.setEvaCheckFluidSensor(1);
	airCo.setEvaRequirMaintenance(1);
	airCo.setCondReview("condReview");
    airCo.setCondCleanElectricSystem(0);
    airCo.setCondClean(1);
	...
	//see.write(serv.getReport(new AirCoServicePolicyDTO(policy, "equipmentType", serviceOrder,  airCo)));
	//see.close();
