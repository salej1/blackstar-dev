...
public class EmergencyPlantServiceReport extends AbstractReport {
  ...
  private void printInformation() throws Exception {
	...
	drawer.text(this.serviceCheckEval(data.getFilterFuelFlag() ), 463, 184, true);
	...
	drawer.text(this.serviceCheckEval(data.getFilterOilFlag() ), 463, 195, true);
	...
	drawer.text(this.serviceCheckEval(data.getFilterWaterFlag() ), 463, 206, true);
	...
	drawer.text(this.serviceCheckEval(data.getFilterAirFlag() ), 463, 217, true);
  ...
  private void printInspection() throws Exception {
	...
	drawer.text(this.serviceCheckEval(data.getLevelOilFlag() ), 95, 298, true);
	...
	drawer.text(this.serviceCheckEval(data.getLevelWaterFlag() ), 95, 313, true);
	...
	drawer.text(this.serviceCheckEval(data.getTubeLeak()), 95, 338, true);
  ...
  private void printServices() throws Exception {
	...
	drawer.text(this.serviceCheckEval(data.getWashEngine()), 95, 359, true);
	drawer.text("SOPLETEADO DE TRANSFER: ", 186, 361, false, 0, 6);
	drawer.text(this.serviceCheckEval(data.getCleanTransfer()), 279, 359, true);
	drawer.text("PRUEBAS DE BATERIAS ", 370, 361, false, 0, 6);
	drawer.text(this.serviceCheckEval(data.getBatteryTests()), 463, 359, true);
	drawer.hLine(0, 555, 363, 0x0155A5);
	drawer.text("LAVADO DE RADIADOR: ", 2, 371, false, 0, 6);
	drawer.text(this.serviceCheckEval(data.getWashRadiator()), 95, 371, true);
	drawer.text("LIMPIEZA TARJETAS DE CONTROL: ", 186, 371, false, 0, 5);
	drawer.text(this.serviceCheckEval(data.getCleanCardControl()), 279, 371, true);
	drawer.text("REV. CARGADOR DE BAT/ALERNADOR ", 370, 371, false, 0, 4.5F);
	drawer.text(this.serviceCheckEval(data.getCheckCharger()), 463, 371, true);
	drawer.hLine(0, 555, 374, 0x0155A5);
	drawer.text("LIMPIEZA AREA DE TRABAJO: ", 2, 383, false, 0, 6);
	drawer.text(this.serviceCheckEval(data.getCleanWorkArea()), 95, 383, true);
	drawer.text("AJUSTE CONEXIONES CONTROL: ", 186, 383, false, 0, 5.5F);
	drawer.text(this.serviceCheckEval(data.getCheckConectionControl()), 279, 383, true);
	drawer.text("PINTURA Y CONSERVACION: ", 370, 383, false, 0, 6);
	drawer.text(this.serviceCheckEval(data.getCheckPaint()), 463, 383, true);
	drawer.hLine(0, 555, 385, 0x0155A5);
	drawer.text("REVISION DE CABLEADO Y CONEXIONES ", 2, 393, false, 0, 4.5F);
	drawer.text(this.serviceCheckEval(data.getConectionCheck()), 95, 393, true);
	drawer.text("REV. DE EXITATRIZ/EMBOBINADOS: ", 186, 393, false, 0, 5F);
	drawer.text(this.serviceCheckEval(data.getCheckWinding()), 279, 393, true);
	drawer.text("SOPLETEADO TAB. GENERADOR: ", 370, 393, false, 0, 5.5F);
	drawer.text(this.serviceCheckEval(data.getCleanGenerator()), 463, 393, true);
  ...
  public static void main(String [] args) throws Exception{
	...
	emergencyPlantService.setFilterFuelFlag(1);
	emergencyPlantService.setFilterOilFlag(0);
	emergencyPlantService.setFilterWaterFlag(1);
	emergencyPlantService.setFilterAirFlag(0);
	...
	emergencyPlantService.setLevelOilFlag(0);
	emergencyPlantService.setLevelWaterFlag(1);
	emergencyPlantService.setLevelBattery("52");
	emergencyPlantService.setTubeLeak(0);
	...
	emergencyPlantService.setWashEngine(0);
	emergencyPlantService.setWashRadiator(1);
	emergencyPlantService.setCleanWorkArea(1);
	emergencyPlantService.setConectionCheck(0);
	emergencyPlantService.setCleanTransfer(1);
	emergencyPlantService.setCleanCardControl(0);
	emergencyPlantService.setCheckConectionControl(0);
	emergencyPlantService.setCheckWinding(1);
	emergencyPlantService.setBatteryTests(0);
	emergencyPlantService.setCheckCharger(0);
	emergencyPlantService.setCheckPaint(1);
	emergencyPlantService.setCleanGenerator(1);
	emergencyPlantService.setEpServiceDynamicTestId(542);
	emergencyPlantService.setVacuumFrequency("12");
	emergencyPlantService.setChargeFrequency("45");
	emergencyPlantService.setBootTryouts("45");
	emergencyPlantService.setVacuumVoltage("78");
	emergencyPlantService.setChargeVoltage("52");
	emergencyPlantService.setQualitySmoke("47");
	...
	emergencyPlantService.setBoardClean(0);
	emergencyPlantService.setLampTest(1);
	emergencyPlantService.setScrewAdjust(0);
	emergencyPlantService.setConectionAdjust(0);
