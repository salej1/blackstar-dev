...
createDatabase
** Desc:
crea una version inicial de la base de datos
** Auth:
Sergio A Gomez
...
------------------------------------
** 1    08/08/2013  SAG      
Version inicial: BD, policy, ticket
******************************************************************************/
...
CREATE  TABLE IF NOT EXISTS `blackstarDb`.`policy` (
  ...
  `penalty` VARCHAR(250) NULL DEFAULT NULL ,
  `service` VARCHAR(50) NULL DEFAULT NULL ,
  `includesParts` TINYINT(1) NULL DEFAULT NULL ,
  `exceptionParts` VARCHAR(50) NULL DEFAULT NULL ,
